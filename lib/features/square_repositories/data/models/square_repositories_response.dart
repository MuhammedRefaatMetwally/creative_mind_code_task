class SquareRepositoriesResponse {
  SquareRepositoriesResponse({
      num? id, 
      String? nodeId, 
      String? name, 
      String? fullName, 
    ...
    _hasPullRequests = hasPullRequests;
    _pullRequestCreationPolicy = pullRequestCreationPolicy;
    _topics = topics;
  ...
  SquareRepositoriesResponse.fromJson(dynamic json) {
    _id = json['id'];
    ...
    _hasPullRequests = json['has_pull_requests'];
    _pullRequestCreationPolicy = json['pull_request_creation_policy'];
    // if (json['topics'] != null) {
    //   _topics = [];
  ...
  bool? _hasPullRequests;
  String? _pullRequestCreationPolicy;
...
SquareRepositoriesResponse copyWith({  num? id,
  String? nodeId,
  String? name,
  String? fullName,
  bool? private,
  ...
  num? watchers,
  String? defaultBranch,
}) => SquareRepositoriesResponse(  id: id ?? _id,
  ...
  hasPullRequests: hasPullRequests ?? _hasPullRequests,
  pullRequestCreationPolicy: pullRequestCreationPolicy ?? _pullRequestCreationPolicy,
  ...
  bool? get hasPullRequests => _hasPullRequests;
  String? get pullRequestCreationPolicy => _pullRequestCreationPolicy;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['has_pull_requests'] = _hasPullRequests;
    map['pull_request_creation_policy'] = _pullRequestCreationPolicy;
    if (_topics != null) {
